---
name: ls-prd
description: Shape product direction into a structured PRD with epic breakdown and optional Technical Architecture document. Produces the upstream artifact that feeds ls-epic and the full Liminal Spec pipeline.
---
