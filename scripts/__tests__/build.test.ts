...
describe("source file safety", () => {
  test("src/ files still exist after build", async () => {
    const criticalFiles = [
      ...
      "src/claude-impl/onboarding/01-orientation.md",
      "src/claude-impl/setup/10-spec-pack-discovery.md",
      "src/claude-impl/phases/20-story-cycle.md",
      "src/claude-impl/operations/30-cli-operations.md",
